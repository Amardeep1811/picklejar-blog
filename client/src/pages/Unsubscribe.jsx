...
export default function Unsubscribe() {
  ...
  return (
    <>
      <Helmet>
        <title>Unsubscribe - WalletPickle</title>
      </Helmet>
      ...
      <div className="max-w-xl mx-auto px-6 py-20 min-h-[50vh] flex flex-col items-center justify-center text-center font-[var(--font-ui)]">
        ...
        {status === 'success' && (
          <div className="bg-[#e8f5ed] border border-[#a6d7bb] text-[var(--green-dark)] p-6 rounded-md">
            ...
            <Link to="/" className="inline-block mt-6 px-6 py-2 bg-[var(--ink)] text-white font-medium rounded-md hover:bg-black transition-colors">
              Return Home
            </Link>
          </div>
        )}
